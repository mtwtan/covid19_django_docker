...
def plt_nova_total_deaths_view(request):
  ...
  fig, ax = plt.subplots()
  ax.set_title('Deaths')
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'Fairfax'], label="Fairfax")
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'Arlington'], label="Arlington")
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'District of Columbia'], label="District of Columbia")
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'Montgomery'], label="Montgomery")
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'Loudoun'], label="Loudoun")
  ax.plot('date', 'numdeaths', data=df_nova.loc[df_nova['county'] == 'Alexandria'], label="Alexandria")
