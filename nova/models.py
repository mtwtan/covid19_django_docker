...
class DmvMovingAverage08182020Orig(models.Model):
    date = models.TextField(blank=True, null=True)
    county = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_08182020_orig'


class DmvMovingAverage20200819(models.Model):
    date = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    numrecovered = models.BigIntegerField(db_column='numRecovered', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_20200819'


class DmvMovingAverage202008191535(models.Model):
    date = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    numrecovered = models.BigIntegerField(db_column='numRecovered', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_20200819_1535'


class DmvMovingAverage202008192225(models.Model):
    date = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    numrecovered = models.BigIntegerField(db_column='numRecovered', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_20200819_2225'


class DmvMovingAverage202008192234(models.Model):
    date = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    numrecovered = models.BigIntegerField(db_column='numRecovered', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_20200819_2234'


class DmvMovingAverage202008192251(models.Model):
    date = models.TextField(blank=True, null=True)
    numconfirmed = models.BigIntegerField(db_column='numConfirmed', blank=True, null=True)  # Field name made lowercase.
    numdeaths = models.BigIntegerField(db_column='numDeaths', blank=True, null=True)  # Field name made lowercase.
    numrecovered = models.BigIntegerField(db_column='numRecovered', blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dmv_moving_average_20200819_2251'
